    ...
    <AdminLayout>
        <div class="flex-content container-fluid p-3 p-md-45 bg-white-3">
            <div class="col bg-white border-light shadow rounded p-0 col-divider">
                <div class="p-4">
                    <h5 class="heading-s fw-700 mb-3">{{ $t('form.edit') }} {{ $t('layout.admin.periods_text_2') }}</h5>

                    <form @submit.prevent="form.put(route('admin.periods.update', period.id))">
                        <div class="row mt-4">
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-12 col-sm-6 mt-3">
                                        <div class="form-group">
                                            <InputTextInline name="description" v-model="form.description" :label="$t('layout.admin.periods_text_2')" />
                                    ...
                                    <div class="col-12 col-sm-6 mt-3">
                                        <div class="form-group">
                                            <SelectInputInline
                                                ...
                                                :label="$t('form.current') + ' ' + $t('form.era')"
                                                :placeholder="$t('form.select') + ' ' + $t('form.era')"
                                                v-model="form.era_id"
                                                :options="$page.props.eras"
                                            />
                        ...
                        <div class="row mt-3">
                            <div class="col-12 d-flex justify-content-end">
                                <PrimaryButton class="me-2" type="link" :url="route('admin.periods.index')">{{ $t('form.back') }}</PrimaryButton>
