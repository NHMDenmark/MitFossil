...
const form = useForm({
    ...
    endpoint: props.news.endpoint,
    new_order: props.news.new_order,
    html: props.news.html,
    ...
    <AdminLayout>
        <div class="flex-content container-fluid p-3 p-md-45 bg-white-3">
            <div class="col bg-white border-light shadow rounded p-0 col-divider">
                <div class="p-4">
                    <h5 class="heading-s fw-700 mb-3">{{ $t('form.edit') }} {{ $t('layout.admin.news_text_2') }}</h5>

                    <form @submit.prevent="form.put(route('admin.news.update', news.id))">
                        <div class="row mt-4">
                            <div class="col-12">
                                <div class="row">
