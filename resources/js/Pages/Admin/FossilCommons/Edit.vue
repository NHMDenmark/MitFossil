...
const props = defineProps({
    fossil_common: Object
});

const form = useForm({
    description: props.fossil_common.description,
});
</script>

<template>
    <Head title="Edit Fossil Common" />
    ...
    <AdminLayout>
        <div class="flex-content container-fluid p-3 p-md-45 bg-white-3">
            <div class="col bg-white border-light shadow rounded p-0 col-divider">
                <div class="p-4">
                    <h5 class="heading-s fw-700 mb-3">{{ $t('form.edit') }} {{ $t('layout.admin.commons_text_2') }}</h5>

                    <form @submit.prevent="form.put(route('admin.fossil-commons.update', fossil_common.id))">
                        <div class="row mt-4">
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-12 col-sm-6 mt-3">
                                        <div class="form-group">
                                            <InputTextInline name="description" v-model="form.description" :label="$t('layout.admin.commons_text_2')" />
