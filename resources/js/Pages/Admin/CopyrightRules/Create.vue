    ...
    <AdminLayout>
        <div class="flex-content container-fluid p-3 p-md-45 bg-white-3">
            <div class="col bg-white border-light shadow rounded p-0 col-divider">
                <div class="p-4">
                    <h5 class="heading-s fw-700 mb-3">{{ $t('form.add')}} {{ $t('layout.admin.copyright_rules_text_2') }}</h5>

                    <form @submit.prevent="form.post(route('admin.copyright-rules.store'))">
                        <div class="row mt-4">
                            <div class="col-12">
                                <div class="row">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 d-flex justify-content-end">
                                <PrimaryButton class="me-2" type="link" :url="route('admin.copyright-rules.index')">{{ $t('form.back') }}</PrimaryButton>
